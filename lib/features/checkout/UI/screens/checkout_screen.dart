...
import 'package:ecommerceapp/features/checkout/UI/widgets/billing_address_section.dart';
import 'package:ecommerceapp/features/checkout/UI/widgets/billing_amount_section.dart';
import 'package:ecommerceapp/features/checkout/UI/widgets/billing_payment_section.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: TBtnApp(
          text: 'Checkout',
          onPressed: () async {
            await context.read<CartCubit>().confirmCheckout();
            Navigator.push(
              context,
              MaterialPageRoute(
